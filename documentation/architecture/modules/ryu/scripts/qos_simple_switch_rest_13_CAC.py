...
from ryu.app import simple_switch_13_CAC
...
class SimpleSwitchRest13IpMac(simple_switch_13_CAC.SimpleSwitch13IpMac):
    ...
    def switch_features_handler(self, ev):
        ...
        self.ipv4_to_port.setdefault(datapath.id, {})
...
class SimpleSwitchController(ControllerBase):
    ...
    def list_ip_table(self, req, **kwargs):
        ...
        if dpid not in simple_switch.ipv4_to_port:
